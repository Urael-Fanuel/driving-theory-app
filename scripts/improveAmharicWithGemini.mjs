...
⚠️ MANDATORY: התוכן הקיים משתמש במילה "ሌይን" — זה תעתיק פונטי של המילה האנגלית "lane", לא מילה אמהרית אמיתית. אסור להשתמש במילה הזו או בכל תעתיק פונטי דומה מאנגלית — יש להשתמש במילה האמהרית התקנית ל"נתיב" (למשל "የመንገድ መስመር"). ההסבר וכל השאלות חייבים לתאר במפורש "מעקף" (הסטת נתיב סביב אזור עבודה), לא ניסוח כללי של "שינוי במיקום/מספר נתיבים".`,
};
